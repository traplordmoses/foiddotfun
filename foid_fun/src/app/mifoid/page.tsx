...
const FEATURES = [
  {
    title: "OWN A FOID",
    body: "a 3D character model designed in Blender",
  },
  {
    title: "EARN YOUR TRAITS",
    body: "pray daily, add to the loreboard,\nand propose memes to shape\nhow your MiFOID looks",
  },
  {
    title: "PROVENANCE MATTERS",
    body: 'transfer count = "body count," genesis\nholders get access to the \u201Cvirgin chat\u201D',
  },
  {
    title: "GOVERNANCE POWER",
    body: "MiFOID holders get amplified voting\nweight on the Loreboard",
  },
  {
    title: "MINT",
    body: "3,333 MiFOID NFTs\n0.01 ETH per MiFOID",
  },
];
