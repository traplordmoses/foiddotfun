...
import { EIP712_DOMAIN, EIP712_TYPES, tryNextGateway, truncateAddress } from "@/lib/swipeConstants";
          ...
          <div className="p-4 md:p-6 flex flex-col gap-6">
            ...
            {totalVotes > 0 && (
              <div className="rounded-xl border border-neutral-800 bg-neutral-900/40 p-4">
                ...
                <div className="flex h-3 overflow-hidden rounded-full bg-neutral-800" role="progressbar" aria-label={`${voteCounts.forCount} yes votes, ${voteCounts.againstCount} no votes`}>
                  <div
