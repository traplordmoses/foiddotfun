...
const SLIDES: TourSlide[] = [
  ...
  },
  {
    exe: 'swipe.exe',
    icon: '👆',
    title: 'SWIPE — JUDGE THE CULTURE',
    body: 'Community members submit memes. You swipe to vote. Approved memes get canonized in the Gallery — the permanent yearbook of internet culture.',
    accent: '#a855f7',
    href: '/swipe',
    cta: 'Start Swiping',
  },
  ...
  },
  {
    exe: 'gallery.exe',
    icon: '🏛️',
    title: 'GALLERY — THE YEARBOOK',
    body: 'Every meme that survives the swipe lives here forever. The Gallery is the permanent record — the onchain yearbook of memes.',
    accent: '#fbbf24',
    href: '/gallery',
    cta: 'See the Gallery',
  },
