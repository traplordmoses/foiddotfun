...
//   2. Add an entry below with  src: mediaUrl("/media/my-video.mp4")
...
export const MEDIA_LIBRARY: MediaItem[] = [
  ...
  // ── MIFOID RENDERS ────────────────────────────────────────────────────
  {
    ...
    kind: "image",
    src: mediaUrl("/media/mifoid-workin-like-a-dog.png"),
    addedAt: "2026-07-06",
  ...
  },
  {
    ...
    kind: "image",
    src: mediaUrl("/media/mifoid-full-body.jpg"),
    addedAt: "2026-07-06",
  ...
  },
  {
    ...
    title: "MIFOID // LOWERR",
    kind: "image",
    src: mediaUrl("/media/mifoid-lowerr.jpg"),
    addedAt: "2026-07-06",
  ...
  },
  {
    ...
    title: "SYBAU 💔",
    kind: "image",
    src: mediaUrl("/media/sybau-heartbreak.jpg"),
    addedAt: "2026-07-06",
  ...
  },
  {
    ...
    kind: "image",
    src: mediaUrl("/media/mifoid-blue-headphones.png"),
    addedAt: "2026-07-06",
  ...
  },
  {
    ...
    kind: "image",
    src: mediaUrl("/media/mifoid-single-tear.jpg"),
    addedAt: "2026-07-06",
  ...
  // ── INTERNET-CULTURE ARCHIVE ──────────────────────────────────────────
  {
    ...
    kind: "image",
    src: mediaUrl("/media/bullish-on-foids.jpg"),
    addedAt: "2026-07-06",
  ...
  },
  {
    ...
    kind: "image",
    src: mediaUrl("/media/epic-gold-star.png"),
    addedAt: "2026-07-06",
  ...
  },
  {
    ...
    title: "CHEF HAMSTER",
    kind: "image",
    src: mediaUrl("/media/chef-hamster.jpg"),
    addedAt: "2026-07-06",
  ...
  },
  {
    ...
    kind: "image",
    src: mediaUrl("/media/wire-me-a-band-twin.jpg"),
    addedAt: "2026-07-06",
  },
  {
    id: "post-this-milady",
    ...
    kind: "image",
    src: mediaUrl("/media/post-this-milady.jpg"),
    addedAt: "2026-07-06",
  ...
  },
  {
    ...
    kind: "image",
    src: mediaUrl("/media/peaceful-shi.jpg"),
    addedAt: "2026-07-06",
  },
