 ...
 *  desktop windows (Stage A: FILES + MIFOID · Stage B pt 1: VOTE + ABOUT ·
 *  Stage B pt 2: PRAY + BOARD).
 *  Unmigrated dock items keep navigating their routes. Kept here (not in
 *  Desktop.tsx) so the Dock can answer "is this a shell app?" without
 *  importing the shell's lazy app registry into every route's bundle. */
